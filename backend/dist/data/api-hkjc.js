...
exports.ApiHKJC = exports.ApiHKJCMatchList = void 0;
const api_1 = __importDefault(require("../api/api"));
async function queryHKJC(oddsTypes) {
...
exports.ApiHKJCMatchList = ApiHKJCMatchList;
const ApiHKJC = async () => {
    try {
